jQuery(document).ready(function($) {
    ...
    $('.add-clone').removeAttr("href");
    // Add more clones
    $('.add-clone').click(function() {
        var $input = $(this).parents('.rwmb-input'), $clone_group = $(this).parents('.rwmb-field').attr("clone-group");
    ...
    $('.rwmb-input').delegate('.remove-clone', 'click', function() {
        var $this = $(this), $input = $this.parents('.rwmb-input'), $clone_group = $(this).parents('.rwmb-field').attr('clone-group');
